...
export interface IInterprefyTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IInterprefyTabRemoveProps {

}

/**
 * Implementation of InterprefyTab remove page
 */
export class InterprefyTabRemove  extends TeamsBaseComponent<IInterprefyTabRemoveProps, IInterprefyTabRemoveState> {
